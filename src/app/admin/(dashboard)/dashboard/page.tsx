...
export default function AdminDashboardPage() {
  ...
  const dashboardCards: { label: string; value: string }[] = [
    {
      label: "Total Classes",
      value: formatDigits(dashboardData?.data?.classCount ?? 0),
    },
    {
      label: "Total Students",
      value: formatDigits(dashboardData?.data?.studentCount ?? 0),
    },
    {
      label: "Total Teachers",
      value: formatDigits(dashboardData?.data?.teacherCount ?? 0),
    },
    {
      label: "Total Courses",
      value: formatDigits(dashboardData?.data?.courseCount ?? 0),
    },
  ];
